...
from inflation_forecast.model import create_MLP, create_RNN, create_DL, create_data_loaders, nn_training, make_predict
...
def cross_validation_loss(model, model_type, x_train, y_train, n_split = 5, batch_size = None, epochs = None, lr = None, nodes = None, hidden_size = None, window_size = None, individual = None, kernel_size = None):
    ...
    for train_index, val_index in time_series_cv.split(x_train):
        ...
        if model_type == "scikit":
            ...
            _, _ = nn_training(DL, train_loader, test_loader, epochs, lr, print_error = False)
